...
export const ValueCard = ({ icon, title, description }: ValueCardProps) => {
  return (
    <div className="bg-[#FFFFFF] p-10 rounded-[24px] border border-[#E8E1FF] pl-[30px] pt-[30px] flex flex-col items-start text-left hover:shadow-card-hover transition-all duration-300 h-full">
