...
export const PropertyCardSmall = () => {
  ...
  return (
    <div 
      className="absolute flex items-center justify-between z-50 shadow-[0_20px_50px_rgba(0,0,0,0.12)] border-[2px] border-black max-md:w-[200px] max-md:h-[75px] max-md:p-[14px] max-sm:w-[180px] max-sm:h-[70px] max-sm:p-[12px]" 
      style={{
        width: '220px',
        height: '80px',
        borderRadius: '35px',
    ...
    >
      <div className="flex flex-col justify-center flex-1">
        <h3 className="font-satoshi font-bold text-black text-[17px] leading-tight mb-[2px] max-md:text-[15px] max-sm:text-[14px]">
          Edwin Martins
        </h3>
