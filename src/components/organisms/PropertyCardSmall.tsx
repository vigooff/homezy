...
export const PropertyCardSmall: React.FC<PropertyCardSmallProps> = ({ 
  property, 
  className = "",
  isLastCard = false 
}) => {
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 lg:p-6 mt-[24px] flex flex-col flex-1">
        ...
        <div
          className="flex pt-[15px] pb-[15px] items-center justify-between mx-auto w-[90%] max-[900px]:justify-center max-[900px]:gap-[clamp(16px,5vw,100px)]"
