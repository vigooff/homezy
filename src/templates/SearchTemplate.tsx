  ...
  return (
    <div className="w-full flex flex-col bg-[#FBFAFF]">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          HEADER & SEARCH BAR
      ═══════════════════════════════════════════════════════════════════ */}
      <header className="w-full pt-16 pb-12 bg-white border-b border-[#E8E1FF]/50 mb-10 md:mb-16">
        ...
        {isMobile && (
          <div className="max-w-[1440px] mb-[3%] mx-auto px-[20px] flex flex-col gap-6">
            ...
            <button
              ...
              style={{ height: "58px", paddingTop: "20px", paddingBottom: "20px", paddingLeft: "32px", paddingRight: "32px" }}
            >
          ...
          >
            ...
            <div className="flex items-stretch w-full">
              ...
              <div className="relative flex-shrink-0" style={{ width: '20%' }}>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-2 scale-110">
                ...
                {isFilterOpen && (
                  <div
                    className="fixed inset-0 bg-black/30 z-[200] flex items-start justify-center"
                    style={{ paddingTop: '160px' }}
                    onClick={(e) => { if (e.target === e.currentTarget) setIsFilterOpen(false); }}
                  >
                    <div style={{ width: '441px', maxWidth: '90vw', filter: 'drop-shadow(0px 20px 50px rgba(0,0,0,0.15))' }}>
                      <PopupFilter
      ...
      <div id="results-start" className="w-full">
        ...
        */}
        {isMidRange && (
          ...
          >
            <div className="flex flex-row items-start relative" style={{ gap: '40px' }}>

              {/* MAP — 30% */}
              <section className="flex-shrink-0 sticky top-10" style={{ width: '30%' }}>
                <div className="w-full rounded-[24px] overflow-hidden shadow-sm bg-white border border-[#E8E1FF]" style={{ height: '930px' }}>
                  <MapProvider properties={memoizedProperties} />
                </div>
              </section>

              {/* RIGHT COLUMN — flex-1 = sisa 70% */}
